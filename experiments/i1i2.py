...
class I1I2():
        ...
        with InstrumentManager() as mgr, DataSource(dataset) as data_source, DataSource(tracking_dataset) as tracking_data_source:
            ...
            if not continuous_tracking:
                ...
                for sweep in range(sweeps):
                    ...
                    self.feedback(mgr, sweep, sweeps_until_feedback, z_feedback_every, xyz_step_nm, shrink_every_x_iter,starting_point)
                    for f in freqs:
                ...
                self.finalize(mgr, data_download, I1_sweeps, I2_sweeps)
    ...
    def initialize(self, mgr, sampling_rate,
        ...
        mgr.DAQcontrol.prepare_counting(sampling_rate, math.floor(time_per_sgpoint / mwPulseTime))
