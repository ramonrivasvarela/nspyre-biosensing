...
try:
    ...
    from pulsestreamer.grpc.pulse_streamer_pb2_grpc import PulseStreamerStub
    from pulsestreamer.grpc.pulse_streamer_pb2 import VoidMessage, PulseMessage, SequenceMessage, ClockMessage, DrpClkSetMessage, TriggerMessage, SetNetworkMessage, GetNetworkMessage, HostnameMessage, SetSquareWaveMessage, AnalogCalibrationData, SupplyStatusData
    ...
    assert False, \
"""
Failed to import grpc wrapper generated by the protobuf compiler
Required packages: grpcio, protobuf
Ensure that you have it installed by typing
> pip install grpcio or pip install --upgrade grpcio
> pip install protobuf or pip install --upgrade protobuf
"""
