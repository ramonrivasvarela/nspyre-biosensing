...
np.array([[4, 5, 6], [3.4, 3.6, 3.5]])])
    ...
    def __init__(
        ...
        subsplitter=QtWidgets.QSplitter()
        subsplitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        subsplitter.addWidget(heatmap_with_crosshair)
        subsplitter.addWidget(self.crosshair_manager)
        # splitter
